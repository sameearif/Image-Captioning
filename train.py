...
def distributed_train(rank,
    ...
    if path_args.backbone_save_path != '' or path_args.body_save_path != '':
        ...
        if train_args.is_end_to_end:
            ...
            partially_load_state_dict(model, checkpoint['model_state_dict'])
            print("Body loaded")
            print(args.body_save_path)
            print(args.backbone_save_path)
        else:
...
if __name__ == "__main__":
    ...
    coco_dataset = CocoDatasetKarpathy(
        ...
        precalc_features_hdf5_filepath=None if train_args.is_end_to_end else path_args.features_path,  # NOT SUPPOSED TO USE FEATURES IN ENDTOEND PART
